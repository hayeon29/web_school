...
import { getBoardPage, getBoardContent, sendContent, writeContent, updateContent, deleteContent } from './controllers/contentController.js';
...
import { getLoginResult, getSignUpResult, checkIDExisting, getUserInfoCheck, login, logout, signup, withdrawUser, withdrawComplete } from './controllers/userController.js';
import { auth, clickAuthResult, checkPasswordCorrect } from './controllers/authController.js';
...
app.use((req, res, next) => {
    if((typeof req.session.is_logged_in === "undefined" || typeof req.session.is_logged_in === "null")){
...
app.post('/api/checkuser', getUserInfoCheck);
